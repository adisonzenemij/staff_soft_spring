...
public interface SyAuthenticationConjunct extends ListCrudRepository<SyAuthenticationEntity, Integer> {
    ...
    List<SyAuthenticationEntity> findIdRegister(
    ...
    void updateDto(@Param("newDto") SyAuthenticationDto newDto);
}
